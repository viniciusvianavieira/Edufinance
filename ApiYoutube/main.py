...
youtube = estatisticasYoutube(key_api, id_canal) #variavel que é atribuida a class criada, onde retiramos dela dois parametros
data = youtube.pegar_estatisticas_youtube()
